...
ap.add_argument('-c', '--config',
                help = 'path to yolo config file', default="Yolo3/yolov3.cfg")
ap.add_argument('-w', '--weights',
                help = 'path to yolo pre-trained weights', default="Yolo3/yolov3.weights")
ap.add_argument('-cl', '--classes',
                help = 'path to text file containing class names', default="Yolo3/yolov3.txt")
args = ap.parse_args()
