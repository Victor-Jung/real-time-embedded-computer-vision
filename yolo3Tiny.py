...
ap.add_argument('-c', '--config',
                help = 'path to yolo config file', default="TinyYolo3/yolov3-tiny.cfg")
ap.add_argument('-w', '--weights',
                help = 'path to yolo pre-trained weights', default="TinyYolo3/yolov3-tiny.weights")
ap.add_argument('-cl', '--classes',
                help = 'path to text file containing class names', default="TinyYolo3/yolov3.txt")
args = ap.parse_args()
...
net = cv2.dnn.readNetFromTorch(args.weights, args.config)
